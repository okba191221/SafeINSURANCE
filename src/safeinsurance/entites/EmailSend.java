...
public class EmailSend {
    ...
    public static void main(String args[]) throws AddressException, MessagingException, IOException {
       ...
       // mail.draftEmail("JIHED.Talbi@esprit.tn", "JIHED", 500);
        mail.sendEmail();
    }

    public void sendEmail() throws MessagingException {
        String fromUser = "TALBI.Jihed@esprit.tn";  //Enter sender email id
        String fromUserPassword = "Sitita@jhon1994";  //Enter sender gmail password , this will be authenticated by gmail smtp server
    ...
    public MimeMessage draftEmail(String email) throws AddressException, MessagingException, IOException {
        ...
        String emailSubject = "Email de comfirmation par Jihed";
